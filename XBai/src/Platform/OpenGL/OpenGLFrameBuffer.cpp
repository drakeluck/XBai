...
namespace XBai
{
	...
	namespace Utils
	{
		...
		static GLenum XBaiFBTextureFromatToGL(FramebufferTextureFormat format)
		{
			switch (format)
			{
	...
	void OpenGLFrameBuffer::Invalidate()
	{
		...
		{
			XB_CORE_ASSERT(m_ColorAttachments.size() <= 4, "")
	...
	void OpenGLFrameBuffer::ClearAttachment(uint32_t attachmentIndex, int value)
	{
		...
		glClearTexImage(m_ColorAttachments[attachmentIndex], 0, Utils::XBaiFBTextureFromatToGL(spec.TextureFormat), GL_INT, &value);
	}
}
